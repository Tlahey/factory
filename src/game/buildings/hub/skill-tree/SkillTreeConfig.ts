...
// Skill node types
export type SkillNodeType = "unlock" | "upgrade";
...
export const SKILL_TREE: SkillNode[] = [
  ...
  // === EXTRACTOR BRANCH ===
  {
    ...
    requires: ["root"],
    position: { x: 1, y: 1 },
    unlockDuration: 30, // 30 seconds to unlock
  },
  {
    id: "extractor_1",
    type: "upgrade",
  ...
  // === CHEST BRANCH ===
  {
    ...
    buildingId: "chest",
    level: 0,
    requires: ["extractor_unlock"], // Unlock chest after extractor
    position: { x: 2, y: 2 },
    unlockDuration: 45,
  },
  {
  ...
  // === CONVEYOR BRANCH (unlocked after extractor) ===
  {
    id: "conveyor_unlock",
    type: "unlock",
    buildingId: "conveyor",
  ...
  // === ELECTRIC POLE BRANCH ===
  {
    id: "electric_pole_unlock",
    type: "unlock",
    buildingId: "electric_pole",
    level: 0,
    requires: ["hub_1"], // Unlock after first hub upgrade
    position: { x: 4, y: 1 },
    unlockDuration: 60,
  },
];
