...
| 005 | [Sawmill doesn't show power consumption in HUD](005-sawmill-hud-consumption-missing.md)          | Done   |
...
| 029 | [Keep IO arrow colors unchanged in placement preview](029-preview-mode-io-arrow-color.md)         | Done                                       |
