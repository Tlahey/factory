...
- **Type Safety**: Prefer **String Literal Types** (unions) over primitive `string` for known sets of values (e.g., `BuildingId` or `Direction`). This ensures strict type checking and prevents typos.
