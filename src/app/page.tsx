...
export default function Home() {
  ...
  const togglePause = useCallback((force?: boolean) => {
    setIsPaused(prev => {
      ...
      window.dispatchEvent(new CustomEvent('GAME_TOGGLE_PAUSE', { detail: newState }));
      return newState;
    });
  }, []);
  ...
  const handleSave = useCallback(() => {
    ...
    window.dispatchEvent(new CustomEvent('GAME_SAVE', { detail: { inventory: { ...currentInventory } } }));
