          ...
          <div className="p-6 border-b border-white/10 flex justify-between items-center bg-white/5">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Drag buildings to your hotbar to equip them.
              </p>
            </div>
            <button
              ...
              {Object.values(BUILDINGS).map((b) => {
                ...
                return (
                  <div
                    ...
                    onDragStart={(e) =>
                      !isLimitReached && handleDragStart(e, b.type)
                    }
                    // Hover handlers
                  ...
                  >
                    ...
                    <div className="text-center px-1">
                      <span
                        className={`font-bold text-sm transition-colors block truncate w-full ${isLimitReached ? "text-red-400" : "text-gray-300 group-hover:text-white"}`}
                      >
                        {b.name}
                      </span>
                      {b.maxCount && (
        ...
        <div className="w-96 shrink-0 transition-all duration-200">
          {hoveredBuildingId && BUILDINGS[hoveredBuildingId] ? (
            ...
            <div className="w-full h-[100px] rounded-xl bg-gray-900/95 backdrop-blur-md flex items-center justify-center shadow-xl">
              <div
                className="text-gray-300 text-sm font-medium italic"
